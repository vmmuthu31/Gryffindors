...
const products = [
  {
    ...
    description:
      "Codeless crypto refers to no-code tools in Web3 that allow users to integrate cryptocurrency and blockchain functionality into their applications without writing any code.",
    githublink: "",
    mediumlink: "",
  },
  {
    ...
    name: "Green DAO",
    description:
      "Building an DAO to help the farmers with the supplychain management, getting identity and apply for the loans.",
    githublink: "",
    mediumlink: "",
  },
  {
    ...
    name: "NFT Media",
    description:
      "A decentralised social media platform with account abstraction using Biconomy, storing images and videos in IPFS using NFT Storage and SQL queries using Tableland.",
    githublink: "",
    mediumlink: "",
  },
  {
  ...
  },
  {
    ...
    name: "Crypto Stumps",
    description:
      "A fantasy sports application like dream11 in web3. Players can create their dream 11 and win rewards in crypto.",
    githublink: "",
    mediumlink: "",
  },
  ...
  return (
    <div>
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <p className="text-3xl text-center font-bold mt-16">
          Products/Projects
        </p>
